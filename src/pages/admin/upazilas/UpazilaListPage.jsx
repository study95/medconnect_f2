      ...
      {isOpen && (
        <div style={{ 
          ...
          <div style={{ maxHeight: 200, overflowY: 'auto' }}>
            <div 
              style={{ padding: '10px 14px', fontSize: 12, cursor: 'pointer', color: '#00A88C', fontWeight: 700, textAlign: 'center', background: '#F0FDFA' }}
...
export default function UpazilaListPage() {
  ...
  const hasActiveFilters = search || divisionFilter || districtFilter
    ...
    <div className="admin-container">
      <div className="admin-page-header">
        <div>
          ...
          <p className="admin-page-subtitle">Configure regional sub-districts for local health service optimization</p>
        </div>
        <Link to="/admin/upazilas/create" className="admin-btn admin-btn-primary" style={{ borderRadius: 12, padding: '12px 24px' }}>
          + Add New Upazila
        </Link>
      </div>
        ...
        <div className="admin-card-body" style={{ overflow: 'visible' }}>
          <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(200px, 1fr))', gap: 20, alignItems: 'flex-end' }}>
            ...
            <div style={{ flex: '1 1 240px' }}>
              <label style={{ display: 'block', fontSize: 11, fontWeight: 700, color: '#64748B', marginBottom: 6, textTransform: 'uppercase', letterSpacing: '0.5px' }}>Search Upazila</label>
            ...
            <div style={{ display: 'flex', gap: 8 }}>
              <button className="admin-btn admin-btn-primary" onClick={fetchItems} style={{ height: 42, padding: '0 24px', borderRadius: 10 }}>Refresh</button>
              {hasActiveFilters && (
