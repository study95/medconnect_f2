...
const INITIAL_CONTENT = {
  ...
  hero: {
    ...
    title_line1: 'স্বাস্থ্যই হোক',
    title_line2: 'আপনার অগ্রাধিকার',
    subtitle: 'বিশ্বস্ত ডাক্তার, আধুনিক হাসপাতাল এবং স্বাস্থ্যসেবা তথ্য এখন মুঠোফোনে। সুস্থ জীবন গড়ুন আমাদের সাথে।',
