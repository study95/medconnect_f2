...
export const queryClient = new QueryClient({
  defaultOptions: {
    queries: {
      staleTime: 30 * 1000,              // 30 seconds: Fresh data window, revalidates on change
      ...
      refetchOnMount: true,               // Automatically refetches on mount when query is stale/invalidated
